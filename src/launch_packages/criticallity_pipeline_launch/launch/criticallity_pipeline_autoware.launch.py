...
def generate_launch_description():
    ...
    return launch.LaunchDescription([    
        launch_ros.actions.Node(
            ...
            output='screen',
            parameters=[
                {'input_clusters_topic': '/perception_pipeline/autoware/output_clusters'},
                {'input_twist_topic': '/perception_pipeline/ego_twist'},
                {'input_path_topic': '/perception_pipeline/ego_path'},
                {'output_ttc_topic': '/criticallity_pipeline/autoware/ttc'},
                {'output_marker_topic': '/criticallity_pipeline/autoware/markers'},
                {'ego_width': 1.0},
                {'ego_length': 2.0},
                {'ego_height': 1.0},
