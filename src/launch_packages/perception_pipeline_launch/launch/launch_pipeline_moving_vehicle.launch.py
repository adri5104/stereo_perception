    ...
    return launch.LaunchDescription([
        ...
        launch_ros.actions.Node(
            ...
            parameters=[
                ...
                {'sigma2_flow_y_measurement' : 10.0},
                {'sigma2_flow_x_measurement' : 30.0},
                {'sigma2_depth_system' : 1.0},
                {'sigma2_tx_measurement' : 1e-06},
                {'sigma2_ty_measurement' : 1e-06},
                {'sigma2_tz_measurement' : 10e-05},
                {'sigma2_theta_measurement' : 1.0e-06},
                {'sigma2_phi_measurement' : 1.0e-06},
                {'sigma2_psi_system' : 1.0e-06},
                {'min_depth' : 1.0},
                {'max_depth' : 10.0},
                {'min_height_' :-1.0},
