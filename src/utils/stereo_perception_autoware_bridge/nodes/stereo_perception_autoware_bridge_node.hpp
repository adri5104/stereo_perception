...
class StereoPerceptionAutowareBridgeNode : public rclcpp::Node
{
  ...
  private:
    ...
    /**
     * @brief Callback for the Autoware Predicted objects topic. Takes the received
     ...
     */
    void autowarePredictedObjectsCallback(const autoware_perception_msgs::msg::PredictedObjects::SharedPtr msg);

    /**
     * @brief Converts a single Autoware Predicted object to a stereo perception clustered object.
     * 
     * @param autoware_object The Autoware Predicted object to convert
    ...
    rclcpp::Subscription<autoware_perception_msgs::msg::PredictedObjects>::SharedPtr predicted_objects_sub_; ///< Subscriber for Autoware Predicted objects messages.
