...
\begin{figure*}[!htb]
  ...
  \begin{minipage}{0.45\textwidth}
    \centering
    \scalebox{0.6}{\input{figures/high_level_pp.tikz}}
  \end{minipage}
  \hfill
  % Second diagram on the right
  \begin{minipage}{0.45\textwidth}
    \centering
    \scalebox{0.6}{\input{figures/high_level_cp.tikz}}
  \end{minipage}
  \caption{Side-by-side diagrams of the high level algorithms}
  \label{fig:combined}
\end{figure*}
