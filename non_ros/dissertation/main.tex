...
\FTMstudentthesisTitlePageFTMDesignMastersThesis{Stereo Camera-Based Environment Perception for Automated Vehicles}{Stereokamera-Basierte Umfeldwahrnemung für automatisierte Fahrzeuge}{Adrian Rieker, B.Sc. \vskip0pt Schleißheimer Str. 126 \vskip0pt 80797 München}{\FTMnamesProfLienkamp}{David Brecht, M.Sc.}{\FTMutilsDate{01}{07}{2025}}{./figures/ImagePDF}%
%
%
%% ========================
%% --- Student's Thesis ---
...
\include{source/2_state_of_art}
\include{source/3_methodology}
\include{source/4_results}
\include{source/5_discussion}
\include{source/6_summary}
